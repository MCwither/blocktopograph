...
___ Please attribute @mithrilmania for generating+updating this enum
    ...
    https://gamepedia.cursecdn.com/minecraft_zh_gamepedia/4/40/EntityCSS.png
...
public enum Entity implements NamedBitmapProviderHandle, NamedBitmapProvider {
    ...
    PARROT(30, "Parrot", new String[]{"parrot"}, "parrot", 109),
    COD(112, "Cod", new String[]{"cod"}, "cod", 126),
    ...
    WANDERINGTRADER(118, "WanderingTrader", new String[]{"wandering_trader"}, "wanderingtrader", 281),
    PHANTOM(58, "Phantom", new String[]{"phantom"}, "phantom", 125),
    ...
    //Param 4 & 5 is from Minecraft Wiki
    VILLAGER_NEW(115, "Villager", new String[]{"Villager"}, "villager_v2", 167);
    FOX(121, "Fox", new String[]{"Fox"}, "fox", 280)
    CAT(75, "Cat", new String[]{"Cat"}, "cat", 142),
    PANDA(113, "Panda", new String[]{"Panda"}, "panda", 136);
    //1.14.0
    BEE(122, "Bee", new String[]{"Bee"}, "bee", 291)
    //1.16.0
    //It's namespaced id isn't change
    ZOMBIFIED_PIGLIN(36, "Zombified Piglin", new String[]{"zombified-piglin", "PigZombie", "pigzombie", "zombie-pigman", "zombie_pigman"}, "zombie-pigman", 383),
    PIGLIN(123, "Piglin", new String[]{"Piglin"}, "piglin", 296)
    HOGLIN(124, "Hoglin", new String[]{"Hoglin"}, "hoglin", 301)
    STRIDER(125, "Strider", new String[]{"Strider"}, "strider", 388)
    ZOGLIN(126, "Zoglin", new String[]{"Zoglin"}, "Zoglin", 289)
    //1.16.2 ?
    PIGLIN_BRUTE(127, "Piglin Brute", new String[]{"Piglin Brute"}, "piglin_brute", 296)
